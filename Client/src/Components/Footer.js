    ...
    <div>
        ...
        <div className="row">
          ...
          Download Our apps from 
            ...
            <Link to="/" title="Apple" style={{marginLeft:'10px'}}>
            ...
            <ul className="list-group list-group-flush">
              ...
              <div className='col-md-3 py-3'>
                ...
                <ul className='list-group list-group-flush'>
                    ...
                    <li className='list-group-item bg-dark text-white border-light'>
                        <Link to='/' className='text-decoration-none text-white streached-link'> Retun Poiicy</Link>

                    </li>
                    <li className='list-group-item bg-dark text-white border-light'>
                        <Link to='/' className='text-decoration-none text-white streached-link'> Terms of use</Link>
                        
                    </li>
                    <li className='list-group-item bg-dark text-white border-light'>
                        <Link to='/' className='text-decoration-none text-white streached-link'>Security</Link>
                        
                    </li>
                    <li className='list-group-item bg-dark text-white border-light'>
                        <Link to='/' className='text-decoration-none text-white streached-link'> Privacy</Link>
